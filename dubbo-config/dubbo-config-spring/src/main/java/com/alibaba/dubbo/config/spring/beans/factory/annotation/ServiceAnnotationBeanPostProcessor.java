...
public class ServiceAnnotationBeanPostProcessor implements BeanDefinitionRegistryPostProcessor, EnvironmentAware,
    ...
    private void registerServiceBeans(Set<String> packagesToScan, BeanDefinitionRegistry registry) {
        ...
        for (String packageToScan : packagesToScan) {
            ...
            // Finds all BeanDefinitionHolders of @Service whether @ComponentScan scans or not.registerServiceBeans
    ...
    private void registerServiceBean(BeanDefinitionHolder beanDefinitionHolder, BeanDefinitionRegistry registry,
        ...
        // <3> 校验在 scanner 中是否已经存在 beanName 。若不存在，则进行注册
    ...
    private Class<?> resolveServiceInterfaceClass(Class<?> annotatedServiceBeanClass, Service service) {
        ...
        // 首先从注解上获得
        // Class<?> interfaceClass() default void.class; 一般是满足的
    ...
    /**
     * RuntimeBeanReference ，在解析到依赖的Bean的时侯，解析器会依据依赖bean的name
     * 创建一个RuntimeBeanReference 对象，将这个对象放入BeanDefinition的MutablePropertyValues中
     * @param beanNames
     * @return
     */
